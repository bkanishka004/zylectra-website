...
export const EMAIL_CONFIG = {
  ...
  TEMPLATE_USER_CONFIRMATION: import.meta.env.VITE_EMAILJS_TEMPLATE_USER_CONFIRMATION,
  TEMPLATE_HACKATHON_SIGNUP: import.meta.env.VITE_EMAILJS_TEMPLATE_HACKATHON_SIGNUP,
  TEMPLATE_THANKYOU: import.meta.env.VITE_EMAILJS_TEMPLATE_THANKYOU,
  PUBLIC_KEY_CTA: import.meta.env.VITE_EMAILJS_PUBLIC_KEY_CTA,
  PUBLIC_KEY_CAREERS: import.meta.env.VITE_EMAILJS_PUBLIC_KEY_CAREERS,
