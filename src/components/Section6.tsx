...
import { CheckCircle, BatteryWarning, Star, Zap, AlertTriangle, TrendingDown, TrendingUp, Clock } from "lucide-react";
            ...
            <div className="relative bg-white rounded-2xl shadow-xl border-2 border-emerald-200 p-8 hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 p-3 bg-emerald-50 rounded-xl border border-emerald-100">
                  ...
                  <span className="text-gray-800 font-medium">20% boost in fleet utilization</span>
                </div>
                ...
                <div className="flex items-center gap-4 p-3 bg-emerald-50 rounded-xl border border-emerald-100">
                  ...
                  <span className="text-gray-800 font-medium">15% reduction in charging downtime</span>
                </div>
                ...
                <div className="flex items-center gap-4 p-3 bg-emerald-50 rounded-xl border border-emerald-100">
                  ...
                  <span className="text-gray-800 font-medium">AI-powered route optimization every trip</span>
                </div>
                ...
                <div className="flex items-center gap-4 p-3 bg-emerald-50 rounded-xl border border-emerald-100">
                  ...
                  <span className="text-gray-800 font-medium">Predictive dispatch eliminates guesswork</span>
                </div>
              </div>
            ...
            <div className="relative bg-white rounded-2xl shadow-xl border-2 border-gray-300 p-8 hover:shadow-2xl transition-all duration-300">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 p-3 bg-red-50 rounded-xl border border-red-100">
                  ...
                  <span className="text-gray-700">10-20% vehicle utilization wasted</span>
                </div>
                ...
                <div className="flex items-center gap-4 p-3 bg-red-50 rounded-xl border border-red-100">
                  ...
                  <span className="text-gray-700">Excessive charging downtime & delays</span>
                </div>
                ...
                <div className="flex items-center gap-4 p-3 bg-red-50 rounded-xl border border-red-100">
                  ...
                  <span className="text-gray-700">Manual route planning wastes hours daily</span>
                </div>
                ...
                <div className="flex items-center gap-4 p-3 bg-red-50 rounded-xl border border-red-100">
                  ...
                  <span className="text-gray-700">Surprise breakdowns disrupt operations</span>
                </div>
              </div>
