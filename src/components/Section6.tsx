  ...
  return (
    <section className="relative py-16 px-6 bg-gradient-to-br from-emerald-50 via-teal-50 to-emerald-100 overflow-hidden" id="features">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute bottom-20 right-20 w-40 h-40 bg-red-400 rounded-full blur-2xl animate-pulse delay-1000"></div>
      </div>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-10">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4 leading-tight">
            Be the EV owner everyone{" "}
            <span className="relative inline-block">
              <span className="text-emerald-600">looks up to</span>
            ...
            <div className="relative bg-white rounded-2xl shadow-xl border-2 border-emerald-200 p-8 hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 p-3 bg-emerald-50 rounded-xl border border-emerald-100">
                  ...
                  <span className="text-gray-800 font-medium">Confident on every drive</span>
                </div>
                ...
                <div className="flex items-center gap-4 p-3 bg-emerald-50 rounded-xl border border-emerald-100">
                  ...
                  <span className="text-gray-800 font-medium">Admired as a smarter EV driver</span>
                </div>
                ...
                <div className="flex items-center gap-4 p-3 bg-emerald-50 rounded-xl border border-emerald-100">
                  ...
                  <span className="text-gray-800 font-medium">Leading India's EV revolution</span>
                </div>
              </div>
            ...
            <div className="relative bg-white rounded-2xl shadow-xl border-2 border-gray-300 p-8 hover:shadow-2xl transition-all duration-300">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 p-3 bg-red-50 rounded-xl border border-red-100">
                  ...
                  <span className="text-gray-700">Constantly planning around battery %</span>
                </div>
                ...
                <div className="flex items-center gap-4 p-3 bg-red-50 rounded-xl border border-red-100">
                  ...
                  <span className="text-gray-700">"the one always worrying about charging"</span>
                </div>
                ...
                <div className="flex items-center gap-4 p-3 bg-red-50 rounded-xl border border-red-100">
                  ...
                  <span className="text-gray-700">Missing out on the real EV experience</span>
                </div>
              </div>
        ...
        <div className="text-center mt-8">
          <p className="text-gray-600 text-lg">
            Which EV owner do you want to be?
          </p>
        </div>
      </div>
    </section>
