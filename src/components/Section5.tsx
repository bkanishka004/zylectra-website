      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-8 leading-tight">
          ...
          <span className="relative inline-block mx-2 mb-2">
            <span className="text-red-500 line-through decoration-4 decoration-red-500">won't solve</span>
          </span>
          EV pain.
        </h2>
        ...
        <div className="mb-12 space-y-6">
          <p className="text-xl md:text-2xl text-gray-700">
            ...
            <span className="font-semibold text-gray-500 mx-2">infrastructure</span>.
          </p>
          ...
          <p className="text-xl md:text-2xl text-gray-900">
            It's 
            <span className="font-bold text-emerald-600 mx-2">intelligence</span>.
          </p>
        </div>
        ...
        <div className="flex justify-center items-center space-x-8 mb-12">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-gray-500">Dumb Machine</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-emerald-600 font-semibold">Intelligence</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-emerald-600 font-semibold">Smart EV</p>
          </div>
        </div>
